package net.choco.deathholograms.utility.compatbridge.model;

import lombok.Getter;
import net.choco.deathholograms.utility.compatbridge.MinecraftVersion;
...
public enum CompColor {
     ...
     */
    GRAY(DyeColor.GRAY, null, "SILVER"),
